...
<div class="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 flex items-center justify-center p-4">
    <div class="bg-white rounded-2xl shadow-2xl max-w-lg w-full p-8 transform transition-all">
        ...
        <!-- Title -->
        <h1 class="text-3xl font-bold text-center text-gray-800 mb-3">Selamat! 🎉</h1>

        <!-- Message -->
        <p class="text-center text-gray-600 mb-2">Anda telah menyelesaikan pembacaan buku</p>
        ...
        <div class="bg-blue-50 border-l-4 border-blue-500 p-4 mb-8 rounded">
            <p class="text-sm text-gray-700">
                <span class="font-semibold">📖 Halaman dibaca:</span> {{ $pagesRead }} halaman
            </p>
        </div>

        <!-- Question -->
        <div class="text-center mb-8">
            <p class="text-lg font-medium text-gray-800">Apakah Anda ingin melanjutkan ke Quiz?</p>
            <p class="text-sm text-gray-500 mt-2">Quiz akan membantu menguji pemahaman Anda</p>
        </div>
        ...
        <div class="mt-6 text-center">
            <p class="text-xs text-gray-500">Anda dapat mengakses quiz kapan saja dari halaman library</p>
        </div>
    </div>
</div>
@endsection
