...
<head>
    ...
    <title>{{ config('app.name', 'Nbot') }}</title>
    ...
    <nav class="bg-white shadow mb-6">
        <div class="max-w-7xl mx-auto px-4 py-4 flex justify-between items-center">
            ...
            <div class="flex items-center space-x-4">
                ...
                <a href="{{ url('/library') }}" class="text-gray-700 hover:text-blue-600 px-3">library</a>
...
<div class="flex items-center space-x-2">
    <!-- Avatar / ikon bulat -->
    <a href="{{ route('profile.index') }}" class="w-8 h-8 bg-gray-300 rounded-full block"></a>

    <!-- Username -->
    <a href="{{ route('profile.index') }}" class="text-sm font-medium text-gray-800 hover:underline">
        {{ Auth::user()->name }}
    </a>
