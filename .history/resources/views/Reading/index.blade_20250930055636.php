    ...
    <div class="w-full md:w-3/4 flex flex-col border-b md:border-b-0 md:border-r bg-gray-50">
        ...
        <div class="p-3 bg-gray-200 flex justify-center items-center gap-4 border-t">
            ...
            <form id="submit-form" 
                ...
                <input type="hidden" name="pages_read" id="pages-read-input" value="1">
                <button type="submit" 
                        id="submit-reading" 
...
// Track the maximum page reached
...
document.getElementById('submit-form').addEventListener('submit', function(e) {
    ...
    .then(data => {
        if (data.success) {
            alert('✅ Pembacaan berhasil dicatat! Halaman dibaca: ' + maxPageReached);
