...
pdfjsLib.getDocument(url).promise.then(function(pdfDoc_) {
    pdfDoc = pdfDoc_;
    // tampilkan jumlah halaman sesuai aturan maxPages
    document.getElementById('page-count').textContent = maxPages;
    renderPage(pageNum);
});
...
document.getElementById('next-page').addEventListener('click', function() {
    if (pageNum >= maxPages) return; // 🚫 batasi hanya sampai maxPages
    pageNum++;
    queueRenderPage(pageNum);
});
let pdfDoc = null,
