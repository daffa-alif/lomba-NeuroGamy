...
<div class="max-w-5xl mx-auto mt-10">
    ...
    {{-- Create Form --}}
    <form id="create-book-form" class="grid grid-cols-2 gap-4 mb-6">
        @csrf
        ...
        <input type="text" name="book_description" id="book_description" placeholder="Book description (optional)"
               class="border rounded-lg px-3 py-2">
