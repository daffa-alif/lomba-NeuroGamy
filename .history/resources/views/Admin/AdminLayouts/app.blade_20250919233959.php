        ...
        <nav class="mt-8 px-4">
            <div class="space-y-4">
                ...
                <a href="#" 
                   ...
                   <a href=""
           class="flex items-center p-2 text-gray-200 hover:bg-gray-700 rounded-lg">
            {{-- Icon Categories (Folder Open) --}}
            <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5" fill="none" 
                 viewBox="0 0 24 24" stroke="currentColor">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                      d="M3 7h4l2-2h10a1 1 0 011 1v2H3zM3 7v10a1 1 0 001 1h16a1 1 0 001-1V9H3z" />
            </svg>
            <span class="ml-3">Book Categories</span>
        </a>
