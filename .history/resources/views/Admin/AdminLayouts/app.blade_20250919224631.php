                ...
                <div class="flex items-center space-x-4">
                    ...
                    <div class="relative">
                        ...
                        <div class="absolute right-0 mt-2 w-48 bg-white rounded-lg shadow-lg border border-gray-200 py-2 hidden">
                            <a href="{{ url('/admin/profile') }}" class="flex items-center px-4 py-2 text-gray-700 hover:bg-gray-50 transition-colors">
                                <i class="fas fa-user-circle mr-3"></i>
                                Profile
                            </a>
                            <a href="{{ url('/') }}" class="flex items-center px-4 py-2 text-gray-700 hover:bg-gray-50 transition-colors">
