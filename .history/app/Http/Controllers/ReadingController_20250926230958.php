...
class ReadingController extends Controller
{
    ...
    public function summarize(Request $request, Book $book)
    {
        ...
        // Prompt untuk AI
        $prompt = "Buat ringkasan singkat untuk halaman {$page} dari buku berjudul '{$book->book_title}', dan jangan berikan respon ragu, karena digunakan untuk aplikasi summarize.";
