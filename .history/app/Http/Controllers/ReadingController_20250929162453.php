    ...
    public function show($id)
{
    ...
    // misal kamu sudah punya cara hitung total halaman PDF
    $totalPages = $book->page_count; // kalau kamu simpan di DBe
    // atau gunakan FPDI/pdfparser kalau perlu hitung langsung dari file

    // aturan minimal 5 halaman
    $maxPages = ($totalPages < 5) ? $totalPages : 5;

    return view('reading.show', compact('book', 'totalPages', 'maxPages'));
}
