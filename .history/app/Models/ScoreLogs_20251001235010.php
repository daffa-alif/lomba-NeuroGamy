...
class QuizController extends Controller
{
    ...
    private function generateQuizWithGemini()
    {
        ...
        $prompt = "Generate a quiz with 1 multiple choice questions. Each question should have 4 options (A, B, C, D) with only one correct answer. Return the response in valid JSON format with this exact structure:
        {
