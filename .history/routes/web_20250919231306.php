...
Route::middleware(['auth', 'admin'])->prefix('admin')->group(function () {
    ...
    // Books (CRUD with AJAX)
    Route::get('/books', [BookController::class, 'index'])->name('books.index');   // view + JSON for list
    Route::post('/books', [BookController::class, 'store'])->name('books.store'); // create
    Route::get('/books/{id}', [BookController::class, 'show'])->name('books.show'); // read single
