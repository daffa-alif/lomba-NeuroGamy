...
use App\Http\Controllers\{AiController, AuthController, BookController, UserController, BookClassificationController, LibraryController, ReadingController, ScoreLogsController};
use App\Models\Book;
...
Route::post('/scorelogs', [ScoreLogsController::class, 'store'])
     ->name('scorelogs.store')
     ->middleware('auth');